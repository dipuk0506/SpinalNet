# -*- coding: utf-8 -*-
"""
Created on Tue May 12 23:24:51 2020
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=10):
        ...
        self.fc3 = nn.Linear(first_HL*4, 10) # changed first_HL from second_HL
    ...
    if (epoch+1) % 20 == 0:
        ...
        with torch.no_grad():
            ...
            with open("./results/resnet_log_cifar.txt", "a") as myfile:
                myfile.write('SpinalHL ResNet code CIFAR-10: Seed: {}, Epoch: {}\n'.format(0,epoch+1))
